...
namespace Restaurant_Groep4_test
{
    ...
    public class UnitTest1 {
        ...
        public void Linesneeded_tester() {
            ...
            //71, 144, 267, 70
            int[] expected_results = new int[] {72, 50, 62, 71};
            for (int i = 0; i < 4; i++) {
        ...
        [TestMethod]
        public void Date_LesserThenGreaterThen_Tester() {

            Directory.SetCurrentDirectory(@"C:\Users\Paran\Documents\BackupGit\Restaurant_Applicatie\Restaurant-Groep4\bin\Debug\netcoreapp3.1");
            Program.Start();

            TestRapportText += "Date LesserThenGreaterThen Test: \n" + new string('_', 50) + "\n";

            DateTime today = DateTime.Now;
            Date now = new Date(today.Year, today.Month, today.Day, today.Hour, today.Second);
            Tuple<Date, bool>[] data = new Tuple<Date, bool>[] {
                new Tuple<Date, bool>(new Date(2022, 6, 6, 0, 0), false),       //Less
                new Tuple<Date, bool>(new Date(2021, 6, 6, 0, 0), false),       //greater
                new Tuple<Date, bool>(new Date(2021, 7, 6, 0, 0), false),       //less
                new Tuple<Date, bool>(new Date(2021, 6, 9, 0, 0), false),       //greater
                new Tuple<Date, bool>(new Date(2021, 6, 10, 0, 0), false),      //less
                new Tuple<Date, bool>(new Date(2021, 9, 6, 0, 0), true),         //greater
                new Tuple<Date, bool>(new Date(2020, 9, 6, 0, 0), true)         //greater

            };
            int counter = 0;
            foreach (Tuple<Date, bool> testcase in data) {

                if (counter % 2 == 0) {
                    Assert.IsTrue(testcase.Item2 == (now > testcase.Item1));
                    TestRapportText += $"expected {testcase.Item2} got {now > testcase.Item1}\n";
                }
                else {
                    Assert.IsTrue(testcase.Item2 == (now < testcase.Item1));
                    TestRapportText += $"expected {testcase.Item2} got {now < testcase.Item1}\n";
        ...
        [TestMethod]
        public void InputValid_Tester() {

            Directory.SetCurrentDirectory(@"C:\Users\Paran\Documents\BackupGit\Restaurant_Applicatie\Restaurant-Groep4\bin\Debug\netcoreapp3.1");
            Program.Start();

            TestRapportText += "InputValid_Tester: \n" + new string('_', 50) + "\n";
            string[] data = new string[] { "1", "-1", "10", "hello", "hi", "h3ll0", "0" };
            bool[] expected_results = new bool[] {true, false, false, false, false, false, false };
            ...
            foreach (string item in data) {
                ...
                Program.UserInput = item;
                Assert.IsTrue(ControlHandler.IsInputValid() == expected_results[count]);
                TestRapportText += $"expected {ControlHandler.IsInputValid()} got {expected_results[count]}\n";
                count++;
            }
            Write_rapport();
        }
        ...
        [TestMethod]
        public void EditAccount_Tester() {
            ...
            string[] data_array = new string[] {
                String.Join(Environment.NewLine ,new string[] {"random", "hallo", "randy random", "Example@gmail.com, 06102124"}),
                String.Join(Environment.NewLine ,new string[] {"Thomas", "rio", "Thomas rotter", "Example@hotmail.com, 06915124"}),
            };
            ...
            foreach (string data in data_array) {
                ...
                using (StringReader reader = new StringReader(data)) {
                    ...
                    TestRapportText += "Account creation succesfull: \n";
                }
            }
        ...
        [TestMethod]
        public void InlogPagina_Tester() {
            ...
            string[] data_array = new string[] {
                String.Join(Environment.NewLine ,new string[] {"Admin", "Admin123!"}),
                String.Join(Environment.NewLine ,new string[] {"Hello", "thisisapassword123"}),
            };
            ...
            foreach (string data in data_array) {
                ...
                using (StringReader reader = new StringReader(data)) {
                    ...
                    TestRapportText += "Logged in: \n";
                }
                using (StringReader reader = new StringReader(data)) {

                    Console.SetIn(reader);
                    InlogPagina.EditLogin();
                    TestRapportText += "Logged in: \n";
                }
            }
        }
        ...
        [TestMethod]
        public void ReviewWriter_Tester() {

            Directory.SetCurrentDirectory(@"C:\Users\Paran\Documents\BackupGit\Restaurant_Applicatie\Restaurant-Groep4\bin\Debug\netcoreapp3.1");
            Program.Start();

            TestRapportText += "ReviewWriter_Tester: \n" + new string('_', 50) + "\n";

            string[] data_array = new string[] {
                String.Join(Environment.NewLine ,new string[] {"5", "great place"}),
                String.Join(Environment.NewLine ,new string[] {"-1", "WORST PLACE EVER!!!!"}),
            };

            Tuple<char, int, int>[] data_2 = new Tuple<char, int, int>[] {

                new Tuple<char, int, int>('=', 0, 0),
                new Tuple<char, int, int>('h', 4, 9),
            };
            ...
            foreach (string data in data_array) {
                ...
                using (StringReader reader = new StringReader(data)) {
                    ...
                    TestRapportText += "Review written: \n";
                }
            }
            foreach (Tuple<char, int, int> dat in data_2) {

                char result = Program.display.displaybuffer.Displaybuffer[dat.Item3, dat.Item2];
                Assert.IsTrue(result == dat.Item1);
                TestRapportText += $"expected {dat.Item1} got {result}\n";
            }
        }

        [TestMethod]
        public void ExcludedMethods_Tester() {

            Directory.SetCurrentDirectory(@"C:\Users\Paran\Documents\BackupGit\Restaurant_Applicatie\Restaurant-Groep4\bin\Debug\netcoreapp3.1");
            Program.Start();

            MenuRegister.menuregister[0].Item1.SaveToJSONFirstTime();
            MenuRegister.menuregister[1].Item1.SaveToJSONFirstTime();
            MenuRegister.menuregister[0].Item1.ToDisplay(Program.display);
            MenuRegister.menuregister[1].Item1.ToDisplay(Program.display);
            Account acc = new Account("hello", "hello", "hello", "hello", "hello");
            Account acc2 = new Account("hello", "hello", "hello", "hello", "hello", false);
            Program.display.AddControl(new Control("Terug", ScreenEnum.Mainmenu, false));
            Program.UserInput = "1";
            ...
            MenuRegister.menuregister[1].Item1.ModifyPrivateValue(-1);
            MenuRegister.menuregister[0].Item1.ModifyPrivateValue(-1);
            AdminManager.ToDisplay();
            Date day = new Date(1, 1, 1, 1, 1);
            int p = day.Year;
            p = day.Month;
            p = day.Hour;
            p = day.Minute;
            ...
            using (StringReader reader = new StringReader(String.Join(Environment.NewLine, new string[] { "1", "1", "1", "750", }))) {
        ...
        [TestMethod]
        public void ExcludedMethods_Tester2() {
