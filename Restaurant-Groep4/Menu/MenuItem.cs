...
namespace Restaurant_Groep4.Menu {
    ...
    public class MenuItem {                        //creating a menuitem class
        ...
        public MenuItem(string _name, int _price, string _description, bool _vegetarian, bool _vegan, bool _gluten, bool _zuivel, bool _noten, bool _dieren) { //menuitem constructor
