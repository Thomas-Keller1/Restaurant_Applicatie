...
namespace Restaurant_Groep4.Screens {
    ...
    public static class Menus {
        ...
        public static void ToDisplay() {
            ...
            Program.display.AddString(0, 8, "Afkortingen staan voor:");
            Program.display.AddString(0, 9, "V = vegetarisch - v = veganistisch - G = gluten");
            Program.display.AddString(0, 10, "Z = zuivel - N = noten - D = dieren");
