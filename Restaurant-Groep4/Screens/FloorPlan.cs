...
=======
            Program.display.AddString(0, 0, new string('=', 80));
            Program.display.AddString(0, 2, "Legenda:");
            Program.display.AddString(0, 3, "# = Table");
            Program.display.AddString(0, 4, "^ = chair");
            Program.display.AddString(0, 5, "- or | = walls");
            Program.display.AddString(0, 6, "/ or \\ = door");
            Program.display.AddString(0, 7, "+ = window");
            Program.display.AddString(0, 9, new string('=', 80));
            Program.display.AddString(0, 11, "++-++--+--+++--++---/\\-");
            Program.display.AddString(0, 12, "^  ^^  ^  ^^^  ^^  |  |");
